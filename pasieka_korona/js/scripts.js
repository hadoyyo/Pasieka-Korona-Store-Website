  ...
  function calculateTotalPrice() {
    ...
    cart.forEach(product => {
      if (product.quantity>= 7) {
        if (!cheapestProductWith7Items || product.price < cheapestProductWith7Items.price) {
          cheapestProductWith7Items = product;
        }
      }
    });
    ...
    cart.forEach(product => {
      ...
      discountedTotalPrice += productDiscountedPrice;
    });
